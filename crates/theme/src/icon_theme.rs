...
pub const DEFAULT_ICON_THEME_NAME: &str = "Orion Studio (Default)";
/// The pre-migration name accepted when loading an existing icon-theme setting.
pub const LEGACY_DEFAULT_ICON_THEME_NAME: &str = "Zed (Default)";
