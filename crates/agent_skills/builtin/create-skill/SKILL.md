---
name: create-skill
description: Helps you create new agent skills for Orion Studio. Use this to create a skill, ask about SKILLs.md, or package reusable agent instructions.
---

# Creating an Orion Studio Agent Skill

Use this skill when the user wants to create, edit, or understand agent skills in Orion Studio.
...
After creating the skill, Orion Studio's agent will discover it automatically on the next conversation (no restart is needed for global skills if the `~/.agents/skills/` directory already exists).
