...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::LoadCircle, "Checking for Orion Studio Updates…")
            .icon_animate(true)
            .disabled(true)
    }

    pub fn downloading(progress: Option<f32>) -> Self {
        Self::new(IconName::Download, "Downloading Orion Studio Update…")
            .progress(progress)
            .disabled(true)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::LoadCircle, "Installing Orion Studio Update…")
            .icon_animate(true)
            .tooltip(version)
            .disabled(true)
    }
...
impl Component for UpdateButton {
    ...
    fn description() -> &'static str {
        ...
        show auto-update status and allow users to restart Orion Studio."
    }
