...
pub use agent_server_store::{
    AgentId, AgentServerStore, AgentServersUpdated, ExternalAgentSource,
...
impl DisableAiSettings {
    ...
    /// allowing `disable_ai` to be configured per-project in `.orion/settings.json`.
                ...
                Err(InvalidSettingsError::Tasks { message, path }) => {
                    ...
                    cx.emit(Event::Toast {
                        ...
                        link: Some(ToastLink {
                            ...
                            url: "https://github.com/orion-agents/orion-studio/blob/main/docs/src/tasks.md",
                        }),
                        message,
                    });
                }
