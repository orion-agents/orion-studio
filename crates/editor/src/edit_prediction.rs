...
impl Editor {
    ...
    fn get_prediction_provider_icons(
        ...
        match provider {
            ...
            None => edit_prediction_types::EditPredictionIconSet::new(IconName::OrionPredict),
        }
    }
                ...
                .child(
                    h_flex()
                        ...
                        .child(Button::new("see-docs", "See Docs").size(ButtonSize::Compact).on_click(|_ev, _window, cx| {
                            cx.open_url("https://github.com/orion-agents/orion-studio/blob/main/docs/src/ai/edit-prediction.md#configuring-edit-prediction-keybindings-edit-predictions-keybinding");
                        })),
                )
        })
    }
