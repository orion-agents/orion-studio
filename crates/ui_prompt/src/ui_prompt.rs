...
pub struct OrionPromptRenderer {
    _level: PromptLevel,
...
impl Render for OrionPromptRenderer {
...
impl EventEmitter<PromptResponse> for OrionPromptRenderer {}

impl Focusable for OrionPromptRenderer {
