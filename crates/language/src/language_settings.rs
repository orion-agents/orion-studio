...
pub struct EditPredictionSettings {
    ...
    /// Settings specific to Orion AI's Edit Predictions provider.
    pub zed: OrionEditPredictionSettings,
...
impl EditPredictionSettings {
    ...
    pub fn debounce_for(&self, provider: settings::EditPredictionProvider) -> Duration {
        let delay = match provider {
            ...
            settings::EditPredictionProvider::OpenAiCompatibleApi => self
                ...
                .as_ref()
                .map_or_else(DelayMs::default, |settings| settings.prediction_debounce),
            settings::EditPredictionProvider::Orion => self.zed.prediction_debounce,
    ...
    ///
    /// The Orion AI edit-prediction delegate handles multiple settings providers
    /// (Orion AI, Mercury, Ollama, OpenAI-compatible), so it is identified by name
    ...
    pub fn debounce_for_delegate(&self, delegate_name: &str) -> Duration {
        match delegate_name {
            ...
            "orion-predict" | "zed-predict" => self.debounce_for(self.provider),
            _ => Duration::ZERO,
        }
    }
}
...
#[derive(Clone, Debug, Default)]
pub struct OrionEditPredictionSettings {
    /// Automatic prediction debounce delay.
    pub prediction_debounce: DelayMs,
}
...
impl settings::Settings for AllLanguageSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let orion_settings = edit_predictions.zed.unwrap();
        ...
        Self {
            edit_predictions: EditPredictionSettings {
                ...
                zed: OrionEditPredictionSettings {
                    prediction_debounce: orion_settings.prediction_debounce.unwrap(),
                },
