...
const ORION_INSPECTOR_STYLE_JSON: &str = util_macros::path!("/orion-studio-inspector-style.json");
        ...
        cx.spawn_in(window, {
            ...
            async move |this, cx| {
                ...
                let json_style_buffer =
                    Self::create_buffer_in_project(ORION_INSPECTOR_STYLE_JSON, &project, cx).await;
