...
use language_model::{
    ...
    OPEN_AI_PROVIDER_ID, OPEN_AI_PROVIDER_NAME, ORION_CLOUD_PROVIDER_ID, ORION_CLOUD_PROVIDER_NAME,
...
impl<TP: CloudLlmTokenProvider + 'static> LanguageModel for CloudLanguageModel<TP> {
    ...
    fn telemetry_id(&self) -> String {
        format!("orion.dev/{}", self.model.id)
    }
...
mod tests {
    ...
    fn test_api_error_conversion_with_upstream_http_error() {
        ...
        // Regular 500 error without upstream_http_error should preserve the Orion rejection
