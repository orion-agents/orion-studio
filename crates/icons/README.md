...
Icons are a big part of Orion Studio, and they convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with Orion Studio.
...
Ask an Orion Studio design maintainer to review and adjust any newly introduced icon.
