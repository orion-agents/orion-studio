...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Orion Studio Dev Instance Running",
        ReleaseChannel::Nightly => "Orion Studio Nightly Instance Running",
        ReleaseChannel::Preview => "Orion Studio Preview Instance Running",
        ReleaseChannel::Stable => "Orion Studio Stable Instance Running",
    }
}
