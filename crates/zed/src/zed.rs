...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    ...
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        let task_inspector_panel =
            agent_ui::TaskInspectorPanel::load(workspace_handle.clone(), cx.clone());
        ...
        futures::join!(
            ...
            add_panel_when_ready(task_inspector_panel, workspace_handle.clone(), cx.clone()),
            channels_panel,
