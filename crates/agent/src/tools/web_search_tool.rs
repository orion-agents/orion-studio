...
use gpui::{App, Task};
use language_model::{
    LanguageModelProviderId, LanguageModelToolResultContent, ORION_CLOUD_PROVIDER_ID,
};
...
impl AgentTool for WebSearchTool {
    ...
    /// We currently only support Orion Cloud as a provider.
    fn supports_provider(provider: &LanguageModelProviderId) -> bool {
        provider == &ORION_CLOUD_PROVIDER_ID
    }
