...
const OPEN_ROUTER_APP_REFERER: &str = "https://github.com/orion-agents/orion-studio";
const OPEN_ROUTER_APP_TITLE: &str = "Orion Studio";
...
fn completion_headers(extra_headers: &CustomHeaders) -> CustomHeaders {
    ...
    headers.push((
        ...
        http::HeaderValue::from_static(OPEN_ROUTER_APP_REFERER),
    ));
    headers.push((
...
pub async fn list_models(
    ...
    let request = HttpRequest::builder()
        ...
        .header("HTTP-Referer", OPEN_ROUTER_APP_REFERER)
...
mod tests {
    ...
    fn completion_uses_shared_transport_with_open_router_headers() {
        ...
        assert_eq!(headers["http-referer"], OPEN_ROUTER_APP_REFERER);
