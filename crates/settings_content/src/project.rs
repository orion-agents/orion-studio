...
pub struct ProjectSettingsContent {
    ...
    /// Whether to disable all AI features in Orion Studio.
    ///
    /// Default: false
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Orion Studio.
    /// Default: true
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in Orion Studio.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary Orion Studio should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, Orion Studio will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
