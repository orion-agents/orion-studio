...
impl TitleBar {
    pub fn new(
        ...
        let application_menu = match platform_style {
            PlatformStyle::Mac => {
                if option_env!("ORION_STUDIO_USE_CROSS_PLATFORM_MENU")
                    .or(option_env!("ZED_USE_CROSS_PLATFORM_MENU"))
                    .is_some()
                {
            ...
            client::Status::UpgradeRequired => {
                ...
                let label = match auto_updater.map(|auto_update| auto_update.read(cx).status()) {
                    Some(AutoUpdateStatus::Updated { .. }) => {
                        "Please restart Orion Studio to collaborate"
                    }
                    ...
                    | None => "Please update Orion Studio to collaborate",
                };
                        ...
                        this.custom_entry(
                            move |_window, _cx| {
                                h_flex()
                                    ...
                                    .justify_between()
                                    .child(
                                        Label::new("Restart to update Orion Studio")
                                            .color(Color::Accent),
                                    )
                                    .child(
