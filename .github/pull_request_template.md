...
- [ ] The content adheres to Zed's UI standards ([UX/UI](https://github.com/orion-agents/zed/blob/main/CONTRIBUTING.md#uiux-checklist) and [icon](https://github.com/orion-agents/zed/blob/main/crates/icons/README.md) guidelines)
