---
title: Modelines
description: Configure Orion Studio files with compatible Vim and Emacs modelines.
---

# Modelines

Modelines are special comments at the beginning or end of a file that configure editor settings for that specific file. Orion Studio supports both Vim and Emacs modeline formats, allowing you to specify settings like tab size, indentation style, and file type directly within your files.

## Configuration

Use the [`modeline_lines`](./reference/all-settings.md#modeline-lines) setting to control how many lines Orion Studio searches for modelines:
...
Orion Studio has some compatibility support for [Emacs file variables](https://www.gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html).
...
| Variable                   | Description                    | Orion Studio Setting                                                                       |
| -------------------------- | ------------------------------ | ------------------------------------------------------------------------------------------ |
...
Orion Studio has some compatibility support for [Vim modeline](https://vimhelp.org/options.txt.html#modeline).
...
| Option         | Aliases | Description                       | Orion Studio Setting                                                                       |
| -------------- | ------- | --------------------------------- | ------------------------------------------------------------------------------------------ |
