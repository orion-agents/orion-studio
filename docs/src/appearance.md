---
title: Appearance and Visual Customization - Orion Studio
description: Customize Orion Studio's themes, fonts, icons, UI density, and other visual settings to match your preferences.
---

# Appearance

Customize Orion Studio's visual appearance to match your preferences. This guide covers themes, fonts, icons, and other visual settings.

For information on how the settings system works, see [All Settings](./reference/all-settings.md).

## Customize Orion Studio in 5 Minutes

Here's how to make Orion Studio feel like home:
...
That's it. You now have a personalized Orion Studio setup.
...
Orion Studio supports separate themes for light and dark mode with automatic switching based on your system preference:
...
Orion Studio uses three font settings and their fallback counterparts for different contexts:
...
Orion Studio provides extensive control over UI elements including:
