---
title: Svelte
description: "Configure Svelte language support in Orion Studio, including language servers, formatting, and debugging."
---

# Svelte

Svelte support is available through the upstream-Zed [Svelte extension](https://github.com/zed-extensions/svelte), which Orion Studio consumes through extension compatibility.
...
When inlay hints are enabled in Orion Studio, to make the language server send them back, Orion Studio sets the following initialization options:
