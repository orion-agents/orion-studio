---
title: Biome
description: "Configure Biome language support in Orion Studio, including language servers, formatting, and debugging."
---

# Biome

[Biome](https://biomejs.dev/) support in Orion Studio is provided by the community-maintained [Biome extension](https://github.com/biomejs/biome-zed).
...
See the [Biome extension README](https://github.com/biomejs/biome-zed) for a
complete list of features and configuration options. The third-party repository
retains `biome-zed` in its historical name.
