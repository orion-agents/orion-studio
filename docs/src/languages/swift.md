---
title: Swift
description: "Configure Swift language support in Orion Studio, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Orion Studio is provided by the community-maintained upstream-Zed [Swift extension](https://github.com/zed-extensions/swift), which Orion Studio consumes through extension compatibility.
...
Orion Studio's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
