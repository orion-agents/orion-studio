---
title: Dart
description: "Configure Dart language support in Orion Studio, including language servers, formatting, and debugging."
---

# Dart

Dart support is available through the upstream-Zed [Dart extension](https://github.com/zed-extensions/dart), which Orion Studio consumes through extension compatibility.
...
If you would like to use a specific dart binary or use dart via FVM you can specify the `dart` binary in your Orion Studio settings.jsons file:
...
Dart by-default uses a very conservative maximum line length (80). If you would like the dart LSP to permit a longer line length when auto-formatting, add the following to your Orion Studio settings.json:
