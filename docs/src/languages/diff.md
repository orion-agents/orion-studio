...
Zed will not attempt to format diff files and has [`remove_trailing_whitespace_on_save`](https://orion.dev/docs/reference/all-settings#remove-trailing-whitespace-on-save) and [`ensure-final-newline-on-save`](https://orion.dev/docs/reference/all-settings#ensure-final-newline-on-save) set to false.
