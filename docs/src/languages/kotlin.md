---
title: Kotlin
description: "Configure Kotlin language support in Orion Studio, including language servers, formatting, and debugging."
---

# Kotlin

Kotlin language support in Orion Studio is provided by the community-maintained upstream-Zed [Kotlin extension](https://github.com/zed-extensions/kotlin), which Orion Studio consumes through extension compatibility.
