---
title: R
description: "Configure R language support in Orion Studio, including language servers, formatting, and debugging."
---

# R

R support is available via multiple R Orion Studio extensions:
...
3. Install the [R](https://github.com/ocsmit/zed-r) extension through Orion Studio's extensions manager for basic R language support (syntax highlighting, tree-sitter support) and for [REditorSupport/languageserver](https://github.com/REditorSupport/languageserver) support.

4. Install the [Air](https://posit-dev.github.io/air/) extension through Orion Studio's extensions manager for R code formatting via Air.
...
[Air](https://posit-dev.github.io/air/) provides code formatting for R, including support for format-on-save. The third-party [Air editor integration documentation](https://posit-dev.github.io/air/editor-zed.html) contains the most up-to-date compatible advice. Its `editor-zed.html` route is retained by the provider.

Ensure that you have installed both the [ocsmit/zed-r](https://github.com/ocsmit/zed-r) extension (for general R language awareness in Orion Studio) and the [Air](https://posit-dev.github.io/air/) extension.
...
To use the Orion Studio REPL with R you need to install [Ark](https://github.com/posit-dev/ark), an R Kernel for Jupyter applications.
