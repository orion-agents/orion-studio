---
title: Lua
description: "Configure Lua language support in Orion Studio, including language servers, formatting, and debugging."
---

# Lua

Lua support is available through the upstream-Zed [Lua extension](https://github.com/zed-extensions/lua), which Orion Studio consumes through extension compatibility.
...
To use [LÖVE (Love2D)](https://love2d.org/) in Orion Studio, checkout [LuaCATS/love2d](https://github.com/LuaCATS/love2d) into a folder called `love2d-luacats` into the parent folder of your project:
...
To use [Playdate Lua SDK](https://play.date/dev/) in Orion Studio, checkout [playdate-luacats](https://github.com/notpeter/playdate-luacats) into the parent folder of your project:
...
To enable [Inlay Hints](../configuring-languages.md#inlay-hints) for LuaLS in Orion Studio
