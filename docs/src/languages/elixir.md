---
title: Elixir
description: "Configure Elixir language support in Orion Studio, including language servers, formatting, and debugging."
---

# Elixir

Elixir support is available through the upstream-Zed [Elixir extension](https://github.com/zed-extensions/elixir), which Orion Studio consumes through extension compatibility.
...
Visit the [Configuring Orion Studio](../configuring-zed.md#settings-files) guide for more information on how to edit your settings file.
...
Completions are an experimental feature within Next LS, and are enabled by default in Orion Studio. Disable them by adding the following to your settings file:
...
Refer to the [Debugger](../debugger.md#getting-started) documentation for more information on how debugging works in Orion Studio.
