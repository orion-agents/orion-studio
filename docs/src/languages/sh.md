---
title: Shell Script
description: "Configure Shell Script language support in Orion Studio, including language servers, formatting, and debugging."
---

# Shell Scripts

Shell Scripts (bash, zsh, dash, sh) are supported natively by Orion Studio.
...
Orion Studio supports auto-formatting Shell Scripts using external tools like [`shfmt`](https://github.com/mvdan/sh).
