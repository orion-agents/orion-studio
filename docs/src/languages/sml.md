---
title: Standard ML
description: "Configure Standard ML language support in Orion Studio, including language servers, formatting, and debugging."
---
...
For projects with more than one source file, Millet expects a single root group file. Create a `millet.toml` in the directory you open in Orion Studio:
