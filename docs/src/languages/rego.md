---
title: Rego
description: "Configure Rego language support in Orion Studio, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Orion Studio is provided by the community-maintained [Rego extension](https://github.com/StyraInc/zed-rego).
