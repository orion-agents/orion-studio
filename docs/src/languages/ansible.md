---
title: Ansible
description: "Configure Ansible language support in Orion Studio, including language servers, formatting, and debugging."
---

# Ansible

Support for Ansible in Orion Studio is provided via a community-maintained [Ansible extension](https://github.com/kartikvashistha/zed-ansible).

- Tree-sitter: [upstream Zed fork `zed-industries/tree-sitter-yaml`](https://github.com/zed-industries/tree-sitter-yaml)
...
- or, configure the YAML language server settings to set this schema for all your inventory files that match your inventory pattern, under your Orion Studio settings ([reference](./yaml.md)):
...
When desired, any of the above default settings can be overridden under the `"lsp"` section of your Orion Studio settings file. For example:

```json [settings]
{
  "lsp": {
    // The Orion Studio Ansible extension prefixes all settings with `ansible`
