...
Or you can have zed directly invoke `clang-format` by specifying it as a [formatter](https://orion.dev/docs/reference/all-settings#formatter) in your settings:
