---
title: Finding and Navigating Code - Orion Studio
description: Navigate your codebase in Orion Studio with file finder, project search, go to definition, symbol search, and the command palette.
---

# Finding & Navigating

Orion Studio provides several ways to move around your codebase quickly. Here's an overview of the main navigation tools.

## Command Palette

The Command Palette ({#kb command_palette::Toggle}) is your gateway to almost everything in Orion Studio. Type a few characters to filter commands, then press Enter to execute.
