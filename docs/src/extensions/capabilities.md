...
description: "Extension Capabilities for Orion Studio extensions."
---

# Extension Capabilities

The operations that Orion Studio extensions are able to perform are governed by a capability system.
