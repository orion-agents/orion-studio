...
that project, similar to how you might use `.idea` folders in WebStorm.
...
### Different Keybindings (WebStorm → Orion Studio)

| Action                 | WebStorm    | Orion Studio (JetBrains keymap) |
| ---------------------- | ----------- | -------------------------------- |
