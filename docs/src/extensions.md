---
title: Extensions
description: "Extend Orion Studio with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Orion Studio lets you add new functionality using user-defined extensions.
