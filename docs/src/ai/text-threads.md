...
description: Text threads have been removed from Orion Studio. Use the Agent Panel for all AI conversations.
redirect_to: ./agent-panel.md
---

# Text Threads

Text threads have been removed from Orion Studio.
