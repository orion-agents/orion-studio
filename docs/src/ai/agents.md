---
title: AI Agents in Orion Studio
description: Compare Orion Studio Agent, External Agents, and Terminal Threads.
---
...
| Which model should power Orion Studio AI features? | [LLM Providers](./llm-providers.md) |

The [Orion Studio Agent](./zed-agent.md) uses models configured in Orion Studio. [External Agents](./external-agents.md) and [Terminal Threads](./terminal-threads.md) may use their own model setup.

## Thread Types {#thread-types}

Threads are the units shown in the [Threads Sidebar](./parallel-agents.md#threads-sidebar). Thread types include:

- [Orion Studio Agent](./zed-agent.md) threads
