...
2. To use Zen or Go models, make sure you have enough credits or an active
   ...
   provider in Orion Studio's Agent. You can use them in Orion Studio by running
   OpenCode as an [external agent through ACP](./external-agents.md).
...
The Orion Studio Agent comes preconfigured with OpenCode models. Add custom OpenCode models when you need newer models or models with custom endpoints.
