---
title: Editing Code in Orion Studio
description: Core code editing features in Orion Studio including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

Orion Studio provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
