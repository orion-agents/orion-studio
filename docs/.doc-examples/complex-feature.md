...
title: Orion Studio Editor Git integration documentation
...
> **Note:** You need to configure an available LLM provider, such as a provider accessed with your own API key.
...
If you would like to also use Orion Studio for your [git commit message editor](https://git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_core_editor) when committing from the command line, use `orion --wait`:
