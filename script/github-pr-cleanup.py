...
DRAFT_WARNING_MARKER = "<!-- orion-studio-community-automation:stale-draft-warning -->"
DRAFT_CLOSE_MARKER = "<!-- orion-studio-community-automation:close-reason=stale_draft -->"
