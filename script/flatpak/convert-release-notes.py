...
def get_release_info(tag: str):
    url = f"https://api.github.com/repos/orion-agents/orion-studio/releases/tags/{tag}"
...
if __name__ == "__main__":
    ...
    release_info_str += f"    </description>\n"
    release_info_str += f"    <url>https://github.com/orion-agents/orion-studio/releases/tag/{tag}</url>\n"
